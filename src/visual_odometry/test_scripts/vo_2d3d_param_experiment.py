...
class VisualOdometryObjective2d2D:
    ...
    def __call__(self, trial: optuna.Trial):
        ...
        confidence = trial.suggest_float("confidence", 0.950, 0.999, step=0.001)
        reprojection_error = trial.suggest_int("reprojection_error", 1, 6)
        itterations_count = trial.suggest_int("iterations_count", 100, 500, step=100)
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(args.output_dir, "vo_2d3d_study.csv")
