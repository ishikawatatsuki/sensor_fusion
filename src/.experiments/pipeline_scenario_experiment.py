      ...
      try:
        ...
        while True:
          ...
          if SensorType.is_visualization_data(sensor_data.type):
            ...
            # elif sensor_data.type is SensorType.KITTI_CUSTOM_VO:
            ...
            #     sensor_data.type is SensorType.KITTI_CUSTOM_VO or\
            ...
            if self.config.filter.noise_type is NoiseType.DYNAMIC:
              ...
              sensor_t = SensorType.KITTI_CUSTOM_VO_VELOCITY_ONLY if z.shape[0] == 3 else SensorType.KITTI_CUSTOM_VO
